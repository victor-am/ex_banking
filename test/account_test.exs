defmodule AccountTest do
  ...
  describe "send/4" do
    ...
    test "it returns an error when the receiver don't exist and keeps the sender balance" do
    ...
    test "it returns an error when the sender account operation queue is full" do
    ...
    test "it returns an error when the receiver account operation queue is full" do
